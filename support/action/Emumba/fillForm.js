...
export default () => {
    ...
    formSubmit.clickElement(formSubmit.titleName)
    ...
    formSubmit.clickElement(formSubmit.detailsFormField)
    for (var i=1;i<=9;i+=2) {
    ...
    formSubmit.clickElement(formSubmit.phoneFormField);
    ...
    formSubmit.clickElement(formSubmit.addressFormField);
    ...
    formSubmit.clickElement(formSubmit.tagsFormField);
    for (var i=0;i<3;i++) {
